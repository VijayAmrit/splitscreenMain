sap.ui.define([
	"sap/ui/test/Opa5",
	"za/co/spar/orders/display/splitscreenapp/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("za.co.spar.orders.display.splitscreenapp.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "za.co.spar.orders.display.splitscreenapp",
					async: true
				},
				hash: oOptions.hash,
