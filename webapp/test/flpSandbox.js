		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Orders",
									"targetURL": "#zacosparordersdisplaysplitscreenapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zacosparordersdisplaysplitscreenapp-display": {
								"semanticObject": "zacosparordersdisplaysplitscreenapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=za.co.spar.orders.display.splitscreenapp",
									"url": sap.ui.require.toUrl("za/co/spar/orders/display/splitscreenapp")
								}
							}
						}
					}
