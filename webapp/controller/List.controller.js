sap.ui.define([
    ...
    return BaseController.extend("za.co.spar.orders.display.splitscreenapp.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "za.co.spar.orders.display.splitscreenapp.view.ViewSettingsDialog",
                    controller: this
